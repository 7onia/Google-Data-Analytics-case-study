...
-- a total of 812755 start_station_name with null values are determined

SELECT DISTINCT end_station_name, COUNT(*) AS end_station_count
FROM `2023.cyclistic_data`
GROUP BY end_station_name;
-- a total of 855491 end_station_name with null values are found 
